...
// function bubble(arr){
//     for(let i=0;i<arr.length-1;i++){ //first loop used for  how many will happen passess i.e-N-1
...
//Bubble sort 
//when we start from 1 index 
// let arr=[1,5,8,1,6,2,4]
...
//when we start from 0th index 
// let arr=[1,5,8,1,6,2,4]
// function bubblesort(arr){
//     for(let i=0;i<arr.length-1;i++){
//         //for round 1 (n-1)
//         for(let j=0;j<arr.length-1-i;j++){
//             //process element till n-1-i th index
//             if(arr[j]>arr[j+1]){
//                 let temp=arr[j]
//                 arr[j]=arr[j+1]
//                 arr[j+1]=temp
